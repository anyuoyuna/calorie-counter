...
public class ProfileService {
    ...
    private String goalLabel(com.github.anyuoyuna.caloriecounter.entity.enums.GoalType g) {
        return switch (g) {
    ...
    private String activityLabel(com.github.anyuoyuna.caloriecounter.entity.enums.ActivityLevel a) {
        return switch (a) {
